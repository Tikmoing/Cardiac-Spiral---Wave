...
%     u( floor(nx*7/8),floor(ny/8) ) = 0.5;
%     u( floor(nx/8),floor(ny*3/8) ) = 0.5;
%     u( floor(nx*3/8),floor(ny*3/8) ) = 0.5;
%     u( floor(nx*5/8),floor(ny*3/8) ) = 0.5;
%     u( floor(nx*7/8),floor(ny*3/8) ) = 0.5;
%         u( floor(nx/8),floor(ny*5/8) ) = 0.5;
%     u( floor(nx*3/8),floor(ny*5/8) ) = 0.5;
%     u( floor(nx*5/8),floor(ny*5/8) ) = 0.5;
%     u( floor(nx*7/8),floor(ny*5/8) ) = 0.5;
%         u( floor(nx/8),floor(ny*7/8) ) = 0.5;
